...
%     with six digits in microseconds.  The time is expressed in local
%     time, the time zone offset is explicitly specified.  Expected input
%     time system is a number of seconds since the epoch, as in function
%     time().
%
